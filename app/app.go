...
import (
	...
	"exchange-token/docs"
	exchangetokenmodulekeeper "exchange-token/x/exchangetoken/keeper"
)
...
type App struct {
	*runtime.App
	...
	ExchangetokenKeeper exchangetokenmodulekeeper.Keeper
